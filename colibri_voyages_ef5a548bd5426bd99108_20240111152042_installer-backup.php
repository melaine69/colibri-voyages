...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'colibri_voyages_ef5a548bd5426bd99108_20240111152042_archive.zip';
        const ARCHIVE_SIZE       = '474754866';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ef5a548-11152042';
        const SECONDARY_PACKAGE_HASH = '86e9665-11152042';
        const VERSION            = '1.5.8';
